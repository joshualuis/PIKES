        ...
        var d = {
            ...
            _scrollToActive: function () {
                ...
                if (n) {
                    ...
                    if (i) {
                        var o =
                            this.getLayoutMenu().querySelector(".menu-inner");
                        if (
                            ("string" == typeof i &&
            ...
            _bindLayoutAnimationEndEvent: function (e, t) {
                ...
                (this._transitionCallback = function (e) {
                    e.target === i &&
                        (n._unbindLayoutAnimationEndEvent(), t.call(n));
                }),
                    ...
                    this._menuMouseEnter ||
                        ...
                        this._windowTouchStart ||
                            ((this._windowTouchStart = function (t) {
                                (t &&
                                    t.target &&
                                    e._findParent(t.target, ".layout-menu")) ||
                                    e._setMenuHoverState(!1);
                            }),
            ...
            setContentLayout: function () {
                ...
                setTimeout(function () {
                    var n,
                        ...
                        c = [].slice.call(
                            document.querySelectorAll(".container-xxl")
                        ),
                ...
                e.checked
                    ? ("radio" === e.type &&
                          [].slice
                              ...
                              .map(function (e) {
                                  e.closest(".custom-option").classList.remove(
                                      "checked"
                                  );
                              }),
            ...
            off: function () {
                ...
                (r = r.join(".") || null),
                    this._listeners
                        ...
                        .forEach(function (t) {
                            return e._listeners.splice(
                                e._listeners.indexOf(t),
                                1
                            );
                        });
            },
